...
message_loop_001:
	ld a, (hl)
	cp 0
	jr z, message_complete_001
	inc hl
	call print_a                  ; print a character (Mangles 2 items below top of stack)
	jr message_loop_001               ; Loop until done

message_complete_001:
	pop de
	pop bc
	pop af
	inc hl
...
message_loop1:
	...
	jr z, msg_complete
	inc hl
	call UART_TX                  ; print a character (Mangles 2 items below top of stack)
	jr message_loop1               ; Loop until done
msg_complete: 
	pop af                        
	pop de                        
	pop bc                        
